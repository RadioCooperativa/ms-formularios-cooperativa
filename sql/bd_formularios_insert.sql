...
-- CREAR TIPO CLIENTE
SET @nombre_cliente = 'Valenzuela Delarze';
SET @descripcion_cliente  = 'Red de concesionarias';
...
SET @id_usuario  = 1;
SET @rut_persona  = '173042191';
SET @nombre_completo_persona='franciscohuertavargas';
SET @correo_persona ='fhuerta@cooperativa.cl';
SET @telefono_persona = '+56987654321';
...
INSERT INTO  T_CLIENTES (nombre_cliente, descripcion_cliente, fecha_creacion, fecha_modificacion, usuario_creacion, usuario_modificacion, vigente)
SELECT @nombre_cliente, @descripcion_cliente, CURRENT_TIMESTAMP(), NULL, NULL, NULL, 0;
